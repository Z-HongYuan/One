...
#include "OneGameplayAbilityTargetActor_LineTrace.generated.h"

UCLASS()
class ONE_API AOneGameplayAbilityTargetActor_LineTrace : public AOneGameplayAbilityTargetActor_Trace
{
	GENERATED_BODY()

public:
	AOneGameplayAbilityTargetActor_LineTrace();
	/**
