...
#include "OneGameplayAbilityTargetActor_LineTrace.h"


AOneGameplayAbilityTargetActor_LineTrace::AOneGameplayAbilityTargetActor_LineTrace()
{
	PrimaryActorTick.bCanEverTick = true;
}

void AOneGameplayAbilityTargetActor_LineTrace::Configure(const FGameplayAbilityTargetingLocationInfo& InStartLocation, FGameplayTag InAimingTag,
...
void AOneGameplayAbilityTargetActor_LineTrace::ShowDebugTrace(TArray<FHitResult>& HitResults, EDrawDebugTrace::Type DrawDebugType, float Duration)
{
...
#if ENABLE_DRAW_DEBUG
void AOneGameplayAbilityTargetActor_LineTrace::DrawDebugLineTraceMulti(const UWorld* World, const FVector& Start, const FVector& End,
