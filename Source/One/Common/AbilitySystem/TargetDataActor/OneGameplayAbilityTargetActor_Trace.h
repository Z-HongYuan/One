...
#include "OneGameplayAbilityTargetActor_Trace.generated.h"

UCLASS()
class ONE_API AOneGameplayAbilityTargetActor_Trace : public AGameplayAbilityTargetActor
{
	GENERATED_BODY()

public:
	AOneGameplayAbilityTargetActor_Trace();
