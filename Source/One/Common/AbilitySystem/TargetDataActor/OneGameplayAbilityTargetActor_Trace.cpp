...
#include "OneGameplayAbilityTargetActor_Trace.h"
#include "AbilitySystemComponent.h"
#include "AbilitySystemLog.h"


AOneGameplayAbilityTargetActor_Trace::AOneGameplayAbilityTargetActor_Trace()
{
...
void AOneGameplayAbilityTargetActor_Trace::ResetSpread()
{
	bUseAimingSpreadMod = false;
	BaseSpread = 0.0f;
	AimingSpreadMod = 0.0f;
...
float AOneGameplayAbilityTargetActor_Trace::GetCurrentSpread() const
{
...
void AOneGameplayAbilityTargetActor_Trace::StartTargeting(UGameplayAbility* Ability)
{
...
void AOneGameplayAbilityTargetActor_Trace::ConfirmTargetingAndContinue()
{
...
void AOneGameplayAbilityTargetActor_Trace::CancelTargeting()
{
...
void AOneGameplayAbilityTargetActor_Trace::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
	DestroyReticleActors();
	Super::EndPlay(EndPlayReason);
}

void AOneGameplayAbilityTargetActor_Trace::LineTraceWithFilter(TArray<FHitResult>& OutHitResults, const UWorld* World,
...
void AOneGameplayAbilityTargetActor_Trace::AimWithPlayerController(const AActor* InSourceActor, FCollisionQueryParams Params,
...
bool AOneGameplayAbilityTargetActor_Trace::ClipCameraRayToAbilityRange(FVector CameraLocation, FVector CameraDirection, FVector AbilityCenter,
...
void AOneGameplayAbilityTargetActor_Trace::StopTargeting()
{
	SetActorTickEnabled(false);
...
FGameplayAbilityTargetDataHandle AOneGameplayAbilityTargetActor_Trace::MakeTargetData(const TArray<FHitResult>& HitResults) const
{
...
TArray<FHitResult> AOneGameplayAbilityTargetActor_Trace::PerformTrace(AActor* InSourceActor)
{
...
AGameplayAbilityWorldReticle* AOneGameplayAbilityTargetActor_Trace::SpawnReticleActor(FVector Location, FRotator Rotation)
{
	if (ReticleClass)
	{
...
void AOneGameplayAbilityTargetActor_Trace::DestroyReticleActors()
{
...
void AOneGameplayAbilityTargetActor_Trace::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AOneGameplayAbilityTargetActor_Trace::Tick(float DeltaTime)
{
