...
#include "OneTask_WaitTargetDataUsingActor.generated.h"
 ...
 */
UCLASS()
class ONE_API UOneTask_WaitTargetDataUsingActor : public UAbilityTask
{
	GENERATED_BODY()
...
public:
	...
	static UOneTask_WaitTargetDataUsingActor* CreateTargetDataUsingActorProxy(
